...
signin2.addEventListener('click',function(e){
    ...
    setTimeout('name.style.display="flex";',1100)
    setTimeout('email.style.display="none";',1100)  
// }
})
...
signup.addEventListener('click',function(e){
        ...
        setTimeout('name.style.display="none";',1100)
        setTimeout('email.style.display="flex";',1100)
})
